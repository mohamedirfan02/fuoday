...
class EmployeeDepartmentEntity {
  ...
  final List<EmployeeModelEntity> data;
  final List<EmployeeModelEntity> sameDepartment;
  final List<EmployeeModelEntity> sameEmpDepartment;
...
class EmployeeModelEntity {
  ...
  @override
  String toString() {
    return 'EmployeeModelEntity(empName: $empName, empId: $empId, dept: $department, reportingManagerId: $reportingManagerId)';
  }
}
